 ...
 *
 * Data: 13/04/2025
 * Versão 1.2: Correção em chamada de função da biblioteca tft
...
//#define software
//Usa aplicativo OV7670 para mostrar o frame 320x240 no formato YUV
#ifdef software
  #define W320H240
//Pode trabalhar no formato YUV ou RGB com 320x240 ou 160x120 pixels
#else
  #define RGB
  #define W320H240
#endif
...
//Ajuste do IOs
#define XCLK						(GPIOC->IDR & GPIO_PIN_6)	/* Clock para câmera (SAÍDA) */
#define VSYNC						(GPIOC->IDR & GPIO_PIN_2)	/* Sincronismo vertical */
#define HREF						(GPIOC->IDR & GPIO_PIN_13)	/* Sincronismo horizontal */
#define PCLK						(GPIOC->IDR & GPIO_PIN_0)	/* Clock dos pixels */
#define PIXEL						((GPIOC->IDR >> 5) & 0xF8) | ((GPIOC->IDR >> 3) & 0x07); /* Ajuste dos byte com o pixel recebido */
								   /* PC12,11,10,9,8,              5,4,3 */
...
uint8_t camera_rdReg(uint8_t reg);
