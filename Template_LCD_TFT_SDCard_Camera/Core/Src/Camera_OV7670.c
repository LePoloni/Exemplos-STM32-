...
#else
	#ifdef W320H240
		cam_wrReg(REG_CLKRC, 10);     //Valor mínimo empírico do prescaler para escrita direta no LCD
	#else
		#ifdef RGB
			cam_wrReg(REG_CLKRC, 11);     //Valor mínimo empírico do prescaler para escrita direta no LCD
		#else
