...
#define CAMERA_CLK_Pin GPIO_PIN_6
#define CAMERA_CLK_GPIO_Port GPIOC
#define TMS_Pin GPIO_PIN_13
#define TMS_GPIO_Port GPIOA
#define TCK_Pin GPIO_PIN_14
#define TCK_GPIO_Port GPIOA
#define CAMERA_RST_Pin GPIO_PIN_12
#define CAMERA_RST_GPIO_Port GPIOC

/* USER CODE BEGIN Private defines */
#define TFT_SPI_PORT hspi2
//Escolher o modele de driver mais adequado ao display TFT SPI utilizado
